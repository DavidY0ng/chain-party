...
<div id="jackpot pool" class="mb-[80px] flex-col items-center gap-5 flex">
	...
	<div id="total game lose" class="md:hidden flex flex-col gap-2 bg-black/25 rounded-2xl px-5 py-3 w-full max-w-[350px] items-center">
		...
		<div class="flex justify-center items-center gap-1">
			...
			{:else}
			<Text tag="h1" size="default" class=" text-[20px] font-bold text-[#DF61FF] translate-y-[-5%]"
				>{jackpotPoolLoseCount}</Text
			>
			<Text size="default" class="text-[16px]"> / 5</Text>
			{/if}
